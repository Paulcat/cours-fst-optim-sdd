...
\setcounter{enumi}{3}
	...
	\item Réduire la dimension des données de validation avec la même matrice \texttt{U} qui a été utilisée pour les données d'apprentissage. Calculer les prédictions et le taux d'erreurs pour la validation.
\end{enumerate}
