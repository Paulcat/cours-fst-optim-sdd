...
Dans cet exercice, nous allons entraîner un perceptron sur des données synthétiques. Pour cela, nous utiliserons les outils disponibles dans la toolbox "Deep Learning" de MATLAB.
